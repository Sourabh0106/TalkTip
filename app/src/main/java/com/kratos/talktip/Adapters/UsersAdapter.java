...
import com.kratos.talktip.Activities.ChatActivity;
import com.kratos.talktip.R;
import com.kratos.talktip.Models.User;
import com.kratos.talktip.databinding.RowCoversationBinding;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder>{
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()) {
                            ...
                            Objects.requireNonNull(holder.binding.messageTime).setText(dateFormat.format(new Date(time)));
    ...
    public int getItemCount() {
        return users.size();//total number of user return
    }
    ...
    public class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        public UserViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = RowCoversationBinding.bind(itemView);// for bind the sample user View
        }
    }
}
